                ...
                <div class="header">
                    ...
                    @can('create users')
                        <ul class="header-dropdown">
                            <li class="dropdown">
                                <a href="{{route('dashboard.translations.create')}}">Add New</a>
                            </li>
                        </ul>
                    @endcan
                                ...
                                <tr>
                                    ...
                                    <td class="js-sweetalert">
                                        <a class="btn btn-primary text-light"
                                           href="{{ route('dashboard.translations.edit',$translation->id) }}"
                                        ><span class="ti-pencil"></span></a>

                                        <button class="btn btn-raised btn-danger waves-effe ct"
                                                data-url-remove="{{route('dashboard.translations.destroy',$translation->id)}}"
                                                data-type="confirm"
                                        >
