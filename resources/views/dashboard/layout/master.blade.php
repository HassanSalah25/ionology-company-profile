...
{{--        </div>--}}
        ...
        @include('dashboard.layout.navbarright')
        @include('dashboard.layout.sidebar')
        @include('dashboard.layout.rightsidebar')
        <section class="content">
            <div class="block-header">
                @foreach($errors->bags as $error)
                    @dd($errors)
                @endforeach
                <div class="row">
        ...
        <script>
            ...
            showNotification('bg-green', "{{session('success')}}", "bottom", "right", "", "");
            @endsession
            @if ($errors->any() )
            @foreach ($errors->all() as $error)
            showNotification('bg-red', "{{$error}}", "bottom", "right", "", "");
            @endforeach
            @endif
        </script>
        @stack('after-scripts')
