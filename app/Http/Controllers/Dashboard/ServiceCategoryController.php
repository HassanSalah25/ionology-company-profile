...
class ServiceCategoryController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $data['route'] = 'services_categories';
        $filters = ['type' => CategoryType::SERVICE->value];
    ...
    public function store(Request $request)
    {
        ...
        $data['type'] = CategoryType::SERVICE->value;
        ...
        return redirect()->route('dashboard.services_categories.index')->with('success', 'Category created successfully.');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('dashboard.services_categories.index')->with('success', 'Category updated successfully.');
    }
